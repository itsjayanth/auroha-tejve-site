...
export default function GradientMesh({ className, dense = false }: { className?: string; dense?: boolean }) {
  return (
    <div aria-hidden className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)}>
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(110,86,248,0.55) 0%, rgba(110,86,248,0.12) 45%, transparent 70%)",
          filter: "blur(40px)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(169,150,255,0.4) 0%, rgba(169,150,255,0.08) 45%, transparent 70%)",
          filter: "blur(50px)",
        }}
      ...
      {dense ? (
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(68,41,201,0.45) 0%, rgba(68,41,201,0.08) 45%, transparent 70%)",
            filter: "blur(45px)",
          }}
